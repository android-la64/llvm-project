...
declare i32 @llvm.loongarch.csrrd.w(i32)
...
entry:
  ...
  %0 = call i64 @llvm.loongarch.csrrd.d(i64 1)
  store i64 %0, i64* %u64_r, align 8
  ret void
}

declare i64 @llvm.loongarch.csrrd.d(i64)
...
entry:
  ...
  %u32_a = alloca i32, align 4
  %0 = load i32, i32* %u32_a, align 4
  %1 = call i32 @llvm.loongarch.csrwr.w(i32 %0, i32 1)
  store i32 %1, i32* %u32_r, align 4
  ret void
}

declare i32 @llvm.loongarch.csrwr.w(i32, i32)
...
entry:
  ...
  %1 = call i64 @llvm.loongarch.csrwr.d(i64 %0, i64 1)
  store i64 %1, i64* %u64_r, align 8
  ret void
}

declare i64 @llvm.loongarch.csrwr.d(i64, i64)
...
entry:
  ...
  %2 = call i32 @llvm.loongarch.csrxchg.w(i32 %0, i32 %1, i32 1)
  store i32 %2, i32* %u32_r, align 4
  ret void
}

declare i32 @llvm.loongarch.csrxchg.w(i32, i32, i32)
...
entry:
  ...
  %2 = call i64 @llvm.loongarch.csrxchg.d(i64 %0, i64 %1, i64 1)
  store i64 %2, i64* %u64_r, align 8
  ret void
}

declare i64 @llvm.loongarch.csrxchg.d(i64, i64, i64)
...
entry:
  ...
  call void @llvm.loongarch.cacop.w(i32 1, i32 %0, i32 2)
  ret void
}
...
entry:
  ...
  call void @llvm.loongarch.cacop.d(i32 1, i64 %0, i64 2)
  ret void
}

declare void @llvm.loongarch.cacop.d(i32, i64, i64)
